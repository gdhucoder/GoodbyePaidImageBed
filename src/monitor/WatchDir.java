...
//        submitGitChanges();
  ...
  static void usage() {
    System.err.println("usage: java WatchDir local_image_dir remote_image_dir");
    System.exit(-1);
  }
  ...
  public static void main(String[] args) throws IOException {
    ...
    AppConfig.getInstance().setImageDirectory(dir.toString());
    String gitRepo = args[1];
    AppConfig.getInstance().setGitRepo(gitRepo);
